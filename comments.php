            ...
            <?php else : ?>
                <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" id="comment-form" method="post"
                    ...
                    <?php if (is_user_logged_in()) : ?>
                        <p class="info"><?php printf(__('Logged in as <a href="%s/wp-admin/profile.php">%s</a>.', 'aletheme'), get_option('siteurl'), $user_identity); ?>
                    ...
                    <div class="form-item message-box">
                        <textarea name="comment" placeholder="<?php _e('Message', 'aletheme'); ?> *" id="comment"
