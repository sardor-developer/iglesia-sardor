    ...
    <div class="wrapper">
        ...
        <div class="contacts_data cf">
            <div class="third_part">
                <span class="label"><i class="fa fa-phone"
                                       aria-hidden="true"></i><?php echo ale_get_meta('phone_label'); ?></span>
                <span class="value phone_number"><?php echo ale_get_meta('phone_number'); ?></span>
            </div>
            <div class="third_part">
                <span class="label"><i class="fa fa-globe"
                                       aria-hidden="true"></i><?php echo ale_get_meta('address_label'); ?></span>
            ...
            <div class="third_part emailbox">
                ...
                <span class="value"><a href="mailto:"><?php echo ale_get_meta('email'); ?></a></span>
            </div>
        </div>
        <div class="contact_form">
           <div class="inner_page_title"><h3 class="inner_title font_three"><?php echo _e('Contacts from','aletheme'); ?></h3>
           </div>
